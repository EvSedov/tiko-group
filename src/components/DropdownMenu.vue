<template>
  ...
  >
    <nav class="R_TAzU" aria-label="Сайт">
      <ul
        class="y7qwii"
      ...
      >
        <ul class="wkJ2fp wixui-dropdown-menu__submenu" id="comp-ksk3vij4moreContainer"></ul>
      </div>
      <div style="display: none" id="comp-ksk3vij4navContainer-hiddenA11ySubMenuIndication">
